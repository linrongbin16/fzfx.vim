...
command! -bang FzfxLspDiagnostics call fzfx#vim#lsp_diagnostics(<q-args>, <bang>0, {'workspace': 1, 'severity': 'HINT'})
command! -bang FzfxLspDiagnosticsB call fzfx#vim#lsp_diagnostics(<q-args>, <bang>0, {'workspace': 0, 'severity': 4})
