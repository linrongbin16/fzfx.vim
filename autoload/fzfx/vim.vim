...
" providers
let s:live_grep_provider=s:base_dir.'/bin/fzfx_live_grep_provider'
let s:unrestricted_live_grep_provider=s:base_dir.'/bin/fzfx_unrestricted_live_grep_provider'
...
" previewers
let s:git_branches_previewer=s:base_dir.'/bin/fzfx_git_branches_previewer'
